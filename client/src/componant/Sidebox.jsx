...
const Sidebox = ({selectedUser,setSelectedUser}) => {
  ...
  return (
    ...
    ${selectedUser ? "max-md:hidden" : ''}`}>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
            ...
            <input type="text" className='border-none bg-transparent outline-none text-white text-xs 
    ...
    <div className='flex flex-col'>
        {userDummyData.map((user,index)=>(
            ...
            cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                ...
                <img src={user?.avatar || assets.avatar_icon} className='w-[35px] aspect-[1/1] rounded-full' alt="" />
                <div className=' flex flex-col leading-5'>
                 ...
                 {
                        index>2 && <p className='absolute top-4 flex justify-center right-4  text-xs
                        h-5 w-5 items-center rounded-full bg-violet-500/50'>{index}</p>
